...
def main(): 
    ...
    subparsers = parser.add_subparsers(dest='category', help='commands', required=True)

    # Packet management commands
    packet_parser = subparsers.add_parser('packet', help='Packet management commands')
    packet_subparsers = packet_parser.add_subparsers(dest='command', help='Packet management actions', required=True)
    ...
    packet_add_parser.add_argument('--action', type=str, default='DROP', choices=['DROP', 'ACCEPT'], help='Action to take (default: DROP)')
    ...
    packet_remove_parser.add_argument('--action', type=str, default='DROP', choices=['DROP', 'ACCEPT'], help='Action to remove (default: DROP)')
    ...
    port_subparsers = port_parser.add_subparsers(dest='port_command', help='Port management actions', required=True)
    ...
    port_add_parser.add_argument('--action', type=str, default='DROP', choices=['DROP', 'ACCEPT'], help='Action to apply (default: DROP)')
    ...
    port_remove_parser.add_argument('--action', type=str, default='DROP', choices=['DROP', 'ACCEPT'], help='Action to remove (default: DROP)')
    ...
    rate_subparsers = rate_parser.add_subparsers(dest='rate_command', help='Rate limiting actions', required=True)
